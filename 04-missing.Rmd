...
- Adjustments on which countries are compared on which energy sources will therefore likely need to be made.

We look at the same visualization on a by-region basis.
```{r}
...
- For all regions, data availability remains largely constant over time with a high spike in 2020. This is likely due to recency and that some data is not finally collected yet. 
- For some countries, no region could be identified, indicated by "NA" in the last graph. For better comparisons, these countries will be matched.
